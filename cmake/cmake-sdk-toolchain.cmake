...
if(CMAKE_BINARY_DIR MATCHES ".*_link")
  set(CMAKE_SDK_TOOLCHAIN_BUILD_CONFIG link CACHE INTERNAL "sos build config is link")
elseif(CMAKE_BINARY_DIR MATCHES ".*_arm")
  set(CMAKE_SDK_TOOLCHAIN_BUILD_CONFIG arm CACHE INTERNAL "sos build config is arm")
elseif(CMAKE_BINARY_DIR MATCHES ".*_rpi32")
  set(CMAKE_SDK_TOOLCHAIN_BUILD_CONFIG rpi32 CACHE INTERNAL "sos build config is rpi32")
elseif(CMAKE_BINARY_DIR MATCHES ".*_rpi64")
  set(CMAKE_SDK_TOOLCHAIN_BUILD_CONFIG rpi64 CACHE INTERNAL "sos build config is rpi64")
else()
  message(FATAL_ERROR "No Configuration available build in *_link or *_arm directory")
endif()

string(COMPARE EQUAL ${CMAKE_SDK_TOOLCHAIN_BUILD_CONFIG} arm IS_ARM)
string(COMPARE EQUAL ${CMAKE_SDK_TOOLCHAIN_BUILD_CONFIG} rpi32 IS_RPI32)
string(COMPARE EQUAL ${CMAKE_SDK_TOOLCHAIN_BUILD_CONFIG} rpi64 IS_RPI64)
message(STATUS "Toolchain SDK PATH: ${CMAKE_SDK_SDK_PATH} ARM:${IS_ARM} RPI32:${IS_RPI32} RPI64:${IS_RPI64}")
