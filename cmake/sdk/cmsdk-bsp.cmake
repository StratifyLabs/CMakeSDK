...
function(cmsdk_bsp OPTION_LIST HARDWARE_ID START_ADDRESS LIBRARIES)
	...
	set(UPDATED_LINK_FLAGS
		-L${CMSDK_SDK_PATH}/arm-none-eabi/lib/${CMSDK_ARM_ARCH_BUILD_INSTALL_DIR}/${CMSDK_ARM_ARCH_BUILD_FLOAT_DIR}
		-L${CMSDK_SDK_PATH}/lib/gcc/arm-none-eabi/${CMAKE_CXX_COMPILER_VERSION}/${CMSDK_ARM_ARCH_BUILD_INSTALL_DIR}/${CMSDK_ARM_ARCH_BUILD_FLOAT_DIR}
