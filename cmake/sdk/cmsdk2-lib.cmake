...
function(cmsdk2_library_add_targets_for_architectures)
	set(OPTIONS "")
	set(PREFIX ARGS)
	set(ONE_VALUE_ARGS TARGET)
	set(MULTI_VALUE_ARGS DEPENDENCIES TARGETS)
	cmake_parse_arguments(PARSE_ARGV 0 ${PREFIX} "${OPTIONS}" "${ONE_VALUE_ARGS}" "${MULTI_VALUE_ARGS}")
	...
	if(${CMSDK_IS_LINK})
		...
		cmsdk2_update_library_for_architecture(
			TARGET ${ARGS_TARGET}
		)
...
function(cmsdk2_update_library_for_architecture)
	set(OPTIONS "")
	set(PREFIX ARGS)
	set(ONE_VALUE_ARGS TARGET)
	set(MULTI_VALUE_ARGS "")
	...
	foreach(VALUE ${REQUIRED_ARGS})
		if(NOT ARGS_${VALUE})
			message(FATAL_ERROR "cmsdk2_update_library_for_architecture requires ${VALUE}")
		endif()
	endforeach()
